...
Pamiętaj, aby zapisać swój plan wdrożenia jako .ai/flashcard-sets-setid-flashcards.md. Upewnij się, że plan jest szczegółowy, przejrzysty i zapewnia kompleksowe wskazówki dla zespołu programistów.
```
